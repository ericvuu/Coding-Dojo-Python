...
class User(models.Model):
  ...
  # user_messages = a list of messages associated with the given user
  # user_comments = a list of messages associated with the given user
...
class Message(models.Model):
  ...
  created_at = models.DateTimeField(auto_now_add = True)
  updated_at = models.DateTimeField(auto_now = True)
  # message_comments = a list of comments associated with the given message
